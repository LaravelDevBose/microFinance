    ...
    <div class="content">
        <div class="panel border-purple-400">
            <div class="panel-heading bg-purple-300 ">
                <h5 class="panel-title">Add New Department</h5>
                    ...
                    <div class="row " >
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="col-lg-4 control-label" >Department Name: <span class="text-danger text-bold ">*</span></label>
                                <div class="col-md-8">
                                    <div class="input-group-xs">
                                        <input type="text" name="dept_name" class="form-control required " required placeholder="Department Name">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
        ...
        <div class="panel border-teal-400">
            <div class="panel-heading bg-teal-300 ">
                <h5 class="panel-title">Department Information List</h5>
